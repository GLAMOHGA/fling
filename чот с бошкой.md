...
OpenButton.Size = UDim2.new(0, 55, 0, 55) -- Чуть меньше
OpenButton.Position = UDim2.new(0, 20, 0, 40) -- Повыше
...
local colors = {
    ...
    Color3.fromRGB(0, 0, 0)         -- Черный (добавлен)
}
...
local function createHat(character)
    ...
    hatPart.Color = Color3.fromRGB(0, 255, 255)
